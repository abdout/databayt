...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  ...
  <div className="p-6 border rounded-lg">
    ...
    <div className="text-sm text-muted-foreground">
      Version control system. Download from <a href="https://git-scm.com" className="underline hover:text-primary" target="_blank">git-scm.com</a> or install via your OS package manager.
    </div>
  </div>
  <div className="p-6 border rounded-lg">
