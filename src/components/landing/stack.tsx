...
const Stack = () => {
  return (
    <section id="stack">
        ...
        <SectionHeading 
          title="Stack"
          description="Databayt leverages state-of-the-art technology to craft innovative and modern applications, delivering seamless performance, scalability, and a superior user experience."
        />
        
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:grid-cols-3">
          <div className="relative overflow-hidden rounded-sm border hover:border-foreground/70 p-2">
          ...
          <div className="relative overflow-hidden rounded-sm border hover:border-foreground/70 p-2">
            <div className="flex h-[180px] flex-col justify-between  p-6">
              ...
              <div className="space-y-2 pt-1">
                ...
                <p className="text-sm text-muted-foreground">
                  ORM using Prisma and deployed on Plantscale.
                </p>
              </div>
            </div>
          </div>
